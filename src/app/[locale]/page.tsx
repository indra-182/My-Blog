...
export default async function LocaleBlogPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <main id="main-content" className="page-main"><BlogHero dictionary={dictionary} /><Suspense fallback={null}><TranslationNotice dictionary={dictionary} /></Suspense><Suspense fallback={<div className="shell browser"><div className="loading-block" aria-label="Loading posts" /></div>}><PostBrowser posts={posts} locale={value} dictionary={dictionary} /></Suspense></main>;
}
